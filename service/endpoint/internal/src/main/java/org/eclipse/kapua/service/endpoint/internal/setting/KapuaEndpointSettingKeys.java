 ...
 *
 */
public enum KapuaEndpointSettingKeys implements SettingKey {

    /**
     * The key value in the configuration resources.
     */
    ENDPOINT_KEY("endpoint.key"),
    ENDPOINT_EVENT_ADDRESS("endpoint.eventAddress");
     ...
     * @since 1.0
     */
    private KapuaEndpointSettingKeys(String key) {
        this.key = key;
    }

    /**
     * Gets the key for this {@link KapuaEndpointSettingKeys}
     *
     * @since 1.0.0
     *
     */
