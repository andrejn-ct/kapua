...
import org.eclipse.kapua.service.eventlog.logger.EventLogXmlRegistry;
import org.eclipse.persistence.jaxb.JAXBContextFactory;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

public class EventLogJAXBContextProvider implements JAXBContextProvider {

    private static final Logger logger = LoggerFactory.getLogger(EventLogJAXBContextProvider.class);
    ...
    public JAXBContext getJAXBContext() throws KapuaException {
        if (context == null) {
            Class<?>[] classes = new Class<?>[] {
                    EventLog.class,
                    EventLogListResult.class,
                    EventLogXmlRegistry.class,
